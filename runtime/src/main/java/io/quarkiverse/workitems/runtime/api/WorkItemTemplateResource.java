...
import io.quarkiverse.workitems.runtime.model.WorkItemTemplate;
import io.quarkiverse.workitems.runtime.service.WorkItemTemplateService;
...
public class WorkItemTemplateResource {
    ...
    public Response createTemplate(final CreateTemplateRequest request) {
        ...
        t.priority = request.priority() != null
                ? io.quarkiverse.workitems.runtime.model.WorkItemPriority.valueOf(request.priority())
                : null;
